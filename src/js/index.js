const gameNode = document.getElementById('game'); //для блокировки поля
const containerNode = document.getElementById('fifteen'); 
const itemNodes = Array.from(containerNode.querySelectorAll('.item')); //массив элементов
const countItems = 16; //кол-во элементов
